...
int getKeypadStatus()
{
    ...
    GPIO_setAsInputPinWithPullUpResistor(GPIO_PORT_P2, GPIO_PIN5); // COL3
    GPIO_setAsInputPinWithPullUpResistor(GPIO_PORT_P8, GPIO_PIN2); // COL1
    GPIO_setAsInputPinWithPullUpResistor(GPIO_PORT_P8, GPIO_PIN3); // COL2
    ...
    //  int col = 3;
      ...
      GPIO_setOutputLowOnPin(GPIO_PORT_P5, GPIO_PIN3); // output row3 to be high
      ...
      GPIO_setOutputHighOnPin(GPIO_PORT_P5, GPIO_PIN3); // output row2 to be high
      GPIO_setOutputLowOnPin(GPIO_PORT_P1, GPIO_PIN3);
...
void drive_motor(int direction){
...
void setupPins() {
    ...
    //Sensors:
    GPIO_setAsInputPinWithPullUpResistor(GPIO_PORT_P1, GPIO_PIN7); // HE 2
    GPIO_setAsInputPinWithPullUpResistor(GPIO_PORT_P1, GPIO_PIN6); // HE 1
    GPIO_setAsInputPinWithPullUpResistor(GPIO_PORT_P5, GPIO_PIN0); // HE 3
    GPIO_setAsInputPinWithPullUpResistor(GPIO_PORT_P5, GPIO_PIN2); // HE 4
